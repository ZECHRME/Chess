            ...
            if (targetPieceColor !== currentPlayerColor) {
                if (startRow.includes(startId) && !document.querySelector(`[square-id="${targetId}"]`).firstChild) {
                    ...
                    if (enPassantRow.includes(startId)) {
                        if (document.querySelector(`[square-id="${startId - 1}"]`).firstChild) {
                            document.querySelector(`[square-id="${startId - 1}"]`).firstChild.remove();
                            return true;
                        } else if (document.querySelector(`[square-id="${startId + 1}"]`).firstChild) {
                            document.querySelector(`[square-id="${startId + 1}"]`).firstChild.remove();
                            return true;
                        }
                    }
